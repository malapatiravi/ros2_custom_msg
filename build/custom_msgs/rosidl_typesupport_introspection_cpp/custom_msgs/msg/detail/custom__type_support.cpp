...
{
  new (message_memory) custom_msgs::msg::Custom(_init);
}

void Custom_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::Custom *>(message_memory);
  typed_message->~Custom();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Custom_message_member_array[1] = {
  {
    "number",  // name
    ...
    offsetof(custom_msgs::msg::Custom, number),  // bytes offset in struct
...
get_message_type_support_handle<custom_msgs::msg::Custom>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, Custom)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Custom_message_type_support_handle;
}
