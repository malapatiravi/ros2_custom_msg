...
#include <stddef.h>
#include "custom_msgs/msg/detail/custom__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_msgs__msg__Custom__init(message_memory);
}

void Custom__rosidl_typesupport_introspection_c__Custom_fini_function(void * message_memory)
{
  custom_msgs__msg__Custom__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Custom__rosidl_typesupport_introspection_c__Custom_message_member_array[1] = {
  {
    "number",  // name
    ...
    offsetof(custom_msgs__msg__Custom, number),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Custom__rosidl_typesupport_introspection_c__Custom_message_members = {
  ...
  "Custom",  // message name
  1,  // number of fields
  sizeof(custom_msgs__msg__Custom),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, Custom)() {
